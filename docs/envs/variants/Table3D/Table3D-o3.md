...
env = kinder.make("kinder/Table3D-o3-v0")
```
...
![random action GIF](../../assets/random_action_gifs/variants/Table3D-o3.gif)
...
| 60 | cube2 | pose_qz |
| 61 | cube2 | pose_qw |
| 62 | cube2 | grasp_active |
| 63 | cube2 | object_type |
| 64 | cube2 | half_extent_x |
| 65 | cube2 | half_extent_y |
| 66 | cube2 | half_extent_z |

...
env = kinder.make("kinder/ScoopPour3D-o40-v0")
```

## Description

Transfer 40 cubes from the source bin to the green receiving bin on the kitchen
...
[ScoopPour3D family](../../ScoopPour3D.md), with 40 cube objects in the observation.

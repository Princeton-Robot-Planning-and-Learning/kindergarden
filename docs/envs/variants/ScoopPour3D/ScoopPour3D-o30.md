...
Transfer 30 cubes from the source bin to the green receiving bin on the kitchen
...
[ScoopPour3D family](../../ScoopPour3D.md), with 30 cube objects in the observation.

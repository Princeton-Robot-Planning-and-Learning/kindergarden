# Rearrange3D-o2-put_the_boxed_drink_in_front_of_and_the_can_behind_the_bowl

## Usage
```python
import kinder
kinder.register_all_environments()
env = kinder.make("kinder/Rearrange3D-o2-put_the_boxed_drink_in_front_of_and_the_can_behind_the_bowl-v0")
```

## Description
Place the boxed drink in front of the bowl and the can behind it.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/Rearrange3D-o2-put_the_boxed_drink_in_front_of_and_the_can_behind_the_bowl.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/Rearrange3D-o2-put_the_boxed_drink_in_front_of_and_the_can_behind_the_bowl.gif)

# Rearrange3D-o2-put_the_boxed_drink_and_the_can_next_to_the_bowl

## Usage
```python
import kinder
kinder.register_all_environments()
env = kinder.make("kinder/Rearrange3D-o2-put_the_boxed_drink_and_the_can_next_to_the_bowl-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/Rearrange3D-o2-put_the_boxed_drink_and_the_can_next_to_the_bowl.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/Rearrange3D-o2-put_the_boxed_drink_and_the_can_next_to_the_bowl.gif)

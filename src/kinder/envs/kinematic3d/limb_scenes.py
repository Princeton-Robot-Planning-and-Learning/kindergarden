...
from kinder.envs.kinematic3d.limbs import (
    ALL_LIMB_NAMES,
    HumanLimbPyBulletRobot,
    create_human_limb,
)
from kinder.envs.kinematic3d.utils import ASSETS_DIR, NUM_LIMB_JOINTS
...
class WheelchairScene(_RoomScene):

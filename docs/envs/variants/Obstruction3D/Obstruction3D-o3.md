...
env = kinder.make("kinder/Obstruction3D-o3-v0")
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/Obstruction3D-o3.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/Obstruction3D-o3.gif)

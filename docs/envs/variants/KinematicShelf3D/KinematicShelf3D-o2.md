...
env = kinder.make("kinder/KinematicShelf3D-o2-v0")
```

## Description
This variant has 2 objects to place on the shelf.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/KinematicShelf3D-o2.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/KinematicShelf3D-o2.gif)

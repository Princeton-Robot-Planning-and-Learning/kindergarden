...
env = kinder.make("kinder/Packing3D-p2-v0")
```

## Description
This variant has 2 parts to pack into the rack.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/Packing3D-p2.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/Packing3D-p2.gif)

**Random Action Stats**: Total Reward: -25.00, Success: No, Steps: 25

## Example Demonstration
![demo GIF](../../assets/demo_gifs/Packing3D-p2/Packing3D-p2_1770245366.gif)

**Demo Stats**: Total Reward: -89.00, Success: Yes, Steps: 106

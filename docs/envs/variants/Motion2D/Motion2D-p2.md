...
## Description
This variant has 2 narrow passages.

## Initial State Distribution
![initial state GIF](../../assets/initial_state_gifs/variants/Motion2D-p2.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/Motion2D-p2.gif)

**Random Action Stats**: Total Reward: -25.00, Success: No, Steps: 25

## Example Demonstration
![demo GIF](../../assets/demo_gifs/Motion2D-p2/Motion2D-p2.gif)

**Demo Stats**: Total Reward: -60.00, Success: Yes, Steps: 60
